...
const CREATION_GUIDANCE = [
  ...
  "- File path: `<cwd>/.myagent/agents/<name>.md` (project-scope, default)",
  "                or `~/.myagent/agents/<name>.md` (user-scope, shared across projects)",
  ...
  "- After writing, the user must restart myagent for the registry to pick the new file up.",
  "",
