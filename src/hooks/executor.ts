 ...
 *   - env.MYAGENT_PROJECT_DIR = absolute cwd
 ...
 * actually flow control in myagent.
 */
function decodeJsonOutput(
  ...
  if (spec) {
    if (
      ...
      // stderr; the myagent uses console for diagnostics elsewhere.
