 ...
 *   ~/.myagent/output-styles/<name>.md        (user scope)
 *   <cwd>/.myagent/output-styles/<name>.md    (project scope, wins)
 *
...
const BUILT_IN_STYLES: OutputStyleConfig[] = [
  ...
  {
    name: "Explanatory",
    description: "myagent explains its implementation choices and codebase patterns",
    keepCodingInstructions: true,
    source: "built-in",
...
${INSIGHT_FEATURE_PROMPT}`,
  ...
  {
    name: "Learning",
    description: "myagent pauses and asks you to write small pieces of code for hands-on practice",
    keepCodingInstructions: true,
    source: "built-in",
